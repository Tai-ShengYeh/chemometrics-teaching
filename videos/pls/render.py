# Render pipeline — Tecator PLS video -> renders/nir_pls.mp4
...
NARR = ROOT/"assets"/"narration"; REC = ROOT/"record.cjs"; FINAL = RENDERS/"nir_pls.mp4"
PAGES_TIMINGS = [{"i":1,"dur":18},{"i":2,"dur":21},{"i":3,"dur":20},{"i":4,"dur":21},{"i":5,"dur":19},{"i":6,"dur":19},{"i":7,"dur":25},{"i":8,"dur":23},{"i":9,"dur":20},{"i":10,"dur":21},{"i":11,"dur":20},{"i":12,"dur":22},{"i":13,"dur":12},{"i":14,"dur":17}]
def node_env():
...
def mux():
    ...
    print("  ok",FINAL)
try:
    print("=== Tecator PLS render ==="); audio(); rec(); mux(); print(f"=== DONE: {FINAL} ===")
